                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/admin/hang/view/1" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Hãng</p>
                                </a>
                            </li>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Hãng áo</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="container">
                    <form method="post" id="addForm">
                        ...
                        <button class="btn btn-primary" formaction="/admin/hang/add" type="submit" onclick="addProduct()" id="idThem"><i class="fas fa-plus"></i>Thêm Mới</button>
                        <button class="btn btn-primary" formaction="/admin/hang/update" type="submit" onclick="addProduct1()" id="idUpdate"> <i class="fas fa-sync"></i>Cập nhật
                        </button>
                    </form>
                </div>
            </div>
...
<script>
    ...
    if (window.location.href === "http://localhost:8080/admin/hang/view/1") {
