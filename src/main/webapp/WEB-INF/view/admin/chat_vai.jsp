                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Chất vải</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <c:forEach items="${listChatVais}" var="list">
                                            <tr>
                                                <td>${list.ma}</td>
                                                <td>${list.ten}</td>
                                                <td>${list.huong_dan_bao_quan.chitiet}</td>
            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <form method="post" id="addForm">
                        <h3 style="text-align: center">CHẤT VẢI</h3>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="thongtin" rows="3"
                                      name="thongtin">${item.thongtin}</textarea>
                            <span id="errorThongTin" class="text-danger"></span>
                        </div>
                        <div class="form-group">
                            <label>Hướng Dẫn Bảo Quản :</label>
                            <select class="form-control" name="huongDanBaoQuanId">
                                <c:forEach items="${listHuongDanBaoQuans}" var="hdbq">
                                    <option ${item.huong_dan_bao_quan.id == hdbq.id?'selected':''}
                                            value="${hdbq.id}">${hdbq.ten}</option>
                                </c:forEach>
                            </select>
                        </div>
...
<script>
    ...
    if (window.location.href === "http://localhost:8080/admin/chat_vai/view/1") {
    ...
    function clickThem() {
        ...
        document.getElementsByName("thongtin")[0].value = "";
...
<script>
    function addProduct() {
        ...
        var thongtin = document.getElementsByName('thongtin')[0].value;
        var errorTen = document.getElementById('errorTen');
        var errorThongTin = document.getElementById('errorThongTin');
        var hasError = false;
        ...
        <c:forEach var="list" items="${listChatVais}">
        if ("${list.ten}".trim() === ten.trim()) {
            errorTen.innerText = 'Tên chất vải đã tồn tại.';
            document.getElementById('ten').style.borderColor = 'red';
            hasError = true;
        }
        </c:forEach>
        ...
        if (thongtin.trim() === '') {
            errorThongTin.innerText = 'Vui lòng nhập thông tin.';
            document.getElementById('thongtin').style.borderColor = 'red';
            hasError = true;
        } else {
            document.getElementById('thongtin').style.borderColor = 'gray';
            errorThongTin.innerText = '';
        }
