                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/admin/size/view/1" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Size</p>
                                </a>
                            </li>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Size áo</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <form method="post">
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <c:forEach items="${listSizes}" var="list">
                                            <tr>
                                                <td>${list.ma}</td>
                                                <td>${list.ten}</td>
            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <form method="post" id="addForm">
                        <h3 style="text-align: center">SIZE ÁO</h3>
...
<script>
    ...
    if (window.location.href === "http://localhost:8080/admin/size/view/1") {
...
<script>
    function addProduct() {
        ...
        <c:forEach var="list" items="${listSizes}">
        if ("${list.ten}".trim() === ten.trim()) {
            errorTen.innerText = 'Tên size đã tồn tại.';
            document.getElementById('ten').style.borderColor = 'red';
            hasError = true;
        }
        </c:forEach>
