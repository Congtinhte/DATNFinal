                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Form áo</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <c:forEach items="${listForms}" var="list">
                                            <tr>
                                                <td>${list.ma}</td>
                                                <td>${list.ten}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <button formaction="/admin/form/detail" name="detail"
                                                            value="${list.id}"
            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <form method="post" id="addForm">
                        <h3 style="text-align: center">FORM ÁO</h3>
                        ...
                        <button class="btn btn-primary" formaction="/admin/form/add" type="submit"
...
<script>
    ...
    if (window.location.href === "http://localhost:8080/admin/form/view/1") {
...
<script>
    function addProduct() {
        ...
        <c:forEach var="list" items="${listForms}">
        if ("${list.ten}".trim() === ten.trim()) {
            errorTen.innerText = 'Tên form đã tồn tại.';
            document.getElementById('ten').style.borderColor = 'red';
            hasError = true;
        }
        </c:forEach>
