                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/admin/mau_sac/view/1" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Màu sắc</p>
                                </a>
                            </li>
                            ...
                            <form method="post">
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <c:forEach items="${listMauSacs}" var="list">
                                            <tr>
                                                <td>${list.ma}</td>
                                                <td>${list.ten}</td>
            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <form method="post" id="addForm">
                        ...
                        <button class="btn btn-primary" formaction="/admin/mau_sac/add" type="submit"
                                onclick="addProduct()" id="idThem"><i class="fas fa-plus"></i>Thêm Mới
                        </button>
                        <button class="btn btn-primary" formaction="/admin/mau_sac/update" type="submit"
...
<script>
    ...
    if (window.location.href === "http://localhost:8080/admin/mau_sac/view/1") {
